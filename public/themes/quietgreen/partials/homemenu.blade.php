        ...
        <div class="carousel-inner" role="listbox">
            ...
            @else
                <div class="item active">
                    <a href=""><img src="{!! Theme::asset()->url('images/banner1.jpg') !!}" alt="..." class="img-responsive"></a>
                </div>
                <div class="item">
                    <a href=""><img src="{!! Theme::asset()->url('images/banner2.jpg') !!}" alt="..." class="img-responsive"></a>
                </div>
                <div class="item">
                    <a href=""><img src="{!! Theme::asset()->url('images/banner3.jpg') !!}" alt="..." class="img-responsive"></a>
                </div>
            @endif
