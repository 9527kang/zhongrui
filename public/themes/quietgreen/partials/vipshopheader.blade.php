            ...
            @else
                <div class="col-xs-12 col-left col-right">
                    ...
                    <div class="pull-right">
                        ...
                        <ul class="pull-left g-taskbarlist hidden-sm hidden-xs">
                            <li class="pull-left g-taskbarli"><a class="g-taskbar1 g-taskbarbor" href="/user/myTasksList">我是{!! Theme::get('site_config')['site_employer'] ? Theme::get('site_config')['site_employer'] : '雇主' !!} <i class="fa fa-caret-down"></i></a>
                                <div class="g-taskbardown1">
                                    <div><a class="cor-blue2f" href="/task/create">发布任务</a></div>
                                    <div><a class="cor-blue2f" href="/user/myTasksList">我发布的任务<span class="red">@if(Theme::get('my_task') > 0 ){!! Theme::get('my_task') !!} @endif</span></a></div>
                                </div>
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="pull-left hidden-xs">
                    <div class="">
                        <a href="{!! CommonClass::homePage() !!}" class="pull-left">
                            ...
                            @else
                                <img src="{!! Theme::asset()->url('images/mb1/logo1.png') !!}" class="img-responsive wrap-side-img no-margin-top">
                            @endif
                        </a>
                    </div>
                </div>
                ...
                <div class="pull-right hidden-xs cor-gray51 tit">
                    @if(is_file(Theme::get('vip_touch')['logo1']))
