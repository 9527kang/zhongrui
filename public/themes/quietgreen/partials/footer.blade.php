...
<div class="footer-copyright">
    <div class="container">
        <p>@if((isset(Theme::get('site_config')['site_version']) && Theme::get('site_config')['site_version'] == 1) || !isset(Theme::get('site_config')['site_version'])){!! config('kppw.kppw_powered_by') !!}{!! config('kppw.kppw_version') !!}@endif
