            ...
            <div class="collapse navbar-collapse" id="example-navbar-collapse">
                ...
                <div class="issue clearfix row">
                    ...
                    <div class="state pull-left">
                        <a href="/user/index">
                            {{--用户头像--}}
                            <img src="@if(!empty(Theme::get('avatar')) && is_file(Theme::get('avatar'))){!!  url(Theme::get('avatar')) !!}@else {!! Theme::asset()->url('images/default_avatar.png') !!} @endif"
                            ...
                            <div class="login login-end">
                                ...
                                <div class="bd clearfix">
                                    <div class="pull-left img">
                                        <img src="@if(!empty(Theme::get('avatar') && is_file(Theme::get('avatar')))){!!  url(Theme::get('avatar')) !!}@else {!! Theme::asset()->url('images/default_avatar.png') !!} @endif" alt="" width="31" height="34" onerror="onerrorImage('{{ Theme::asset()->url('images/default_avatar.png')}}',$(this))">
                                    </div>
                                    <div class="ostate">
