                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 task-filtersort">
                                                <input type="text" class="col-xs-10 col-sm-5 task-input-depivt" name="title" value="{!! old('title') !!}" id="form-input-readonly" placeholder="一句话描述您的需求，XX餐饮公司VI设计" datatype="*5-50" nullmsg="请填写标题！">
                                                <p class="hidden-xs">
                                                        ...
                                                        <div class="modal-body">
                                                            <div id="myTabContent" class="tab-content">
                                                                ...
                                                                <div class="text-center">
                                                                    <button type="button" onclick="insert_example()" class="btn btn-primary" id="insertTemplate" data-toggle="button">
                                                                        插入模板
                                                                    </button>
                                                                </div>
                                                            </div>
                                    ...
                                    <div class="panel">
                                        ...
                                        {{ (!empty(old('xuanshang')))?'in':'' }}" id="ck">
                                            <div class="mission-ck z-check-validform-ck">
                                                ...
                                                <span class="time_check validform_checktip  Validform_wrong" style="width:90%;margin-left:20px;display:none">
                                                </span>
                                            </div>
                                        </div>
                                        @endif
                                        ...
                                        <div class="mission-task panel-collapse collapse
                                            ...
                                            <div class="mission-ck z-check-validform-ck">
                                                ...
                                                @endif
                                                <input name="begin_at{{$type_v['alias']}}" type="hidden" id="begin_at1" datatype="*" nullmsg="请填写开始时间！" class="begin_at"
