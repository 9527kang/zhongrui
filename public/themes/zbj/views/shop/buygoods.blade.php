                                ...
                                @if($is_contract == true)
                                    @if(Auth::check())
                                        ...
                                        @elseif( Theme::get('is_IM_open') == 1)
                                            <a class="shop-callme shop-im hovim-orange"  href="javascript:;" data-values="{!! $goods_info->uid !!}">联系我</a>
                                        @endif
                                    @else
                                ...
                                <div class="bdsharebuttonbox" data-tag="share_1">
                                    <div class="shop-sharewrap"><span class="pull-left cor-gray51">分享：&nbsp;</span>
                                        <div class="share_top_style">
                                            <a href="javascript:void(0);" class="" onClick="dofristshare('sina','{{$goods_info['title']}}')">
                                                <img src="{!! Theme::asset()->url('images/sina.png') !!}" alt="新浪微博">
                                            </a>

                                            <a href="javascript:void(0);" class="" onClick="dofristshare('tx','{{$goods_info['title']}}')">
                                                <img src="{!! Theme::asset()->url('images/tx.png') !!}" alt="腾讯微博">
                                            </a>

                                            <a href="javascript:void(0);" class="" onClick="dofristshare('rr','{{$goods_info['title']}}')">
                                                <img src="{!! Theme::asset()->url('images/rr.png') !!}" alt="人人网">
                                            </a>

                                            <a href="javascript:void(0);" class="" onClick="dofristshare('qzone','{{$goods_info['title']}}')">
                                                <img src="{!! Theme::asset()->url('images/qq.png') !!}" alt="QQ空间">
                                            </a>

                                            <a href="javascript:void(0);" class="" onClick="dofristshare('douban','{{$goods_info['title']}}')">
