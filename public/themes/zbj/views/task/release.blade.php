                    ...
                    <ul class="mg-margin">
                        <li>
                            ...
                            <div id="demo" class="collapse in">
                                ...
                                <div class="task-bar">
                                    <p class="text-size14" style="text-align:left;margin-top:57px;display: block;margin-bottom:7px;">地域：</p>
                                        ...
                                        @if($type_v['alias'] == 'xuanshang')
                                            ...
                                            {{ (!empty(old('xuanshang')))?'in':'' }} @if($task['type_id'] == $type_v['id'])in active @endif" id="ck">
                                                <div class="mission-ck z-check-validform-ck">
                                                    ...
                                                    <div>
                                                        <input type="number" name="bounty{{$type_v['alias']}}" id="bounty"
                                                    ...
                                                    <div>
                                                        <input type="number" name="worker_num{{$type_v['alias']}}" class="mis-txt"
                                                    ...
                                                    <div class=" input-group" style="width:60%;margin-left:20px;">
                                                        ...
                                                        <div>
                                                            <input type="text" class="input-sm form-control "
                                                                   id="datepiker-begin" onchange="beginAt($(this))" @if($task['type_id'] == $type_v['id'] && $type == 0) value="{!! ($task['begin_at'])?date('Y年m月d日',strtotime($task['begin_at'])):date('Y年m月d日',time()) !!}" @else value="{{date('Y年m月d日',time())}}" @endif
                                                        ...
                                                        <div>
                                                            <input type="text" class="input-sm form-control "
                                                                   ...
                                                                   @if($task['type_id'] == $type_v['id'] && $type == 0) value="{!! ($task['delivery_deadline'])?date('Y年m月d日',strtotime($task['delivery_deadline'])):date('Y年m月d日',time()) !!}" @endif
                                                                   placeholder="截稿时间">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <span class="time_check validform_checktip" style="width:90%;margin-left:20px;display:none">
                                                    </span>
                                                </div>
                                            </div>
                                        @endif
                                        ...
                                        @if($type_v['alias'] == 'zhaobiao')
                                            ...
                                            {{ (!empty(old('zhaobiao')))?'in':'' }}" id="ck1">
                                                <div class="mission-ck z-check-validform-ck">
                                                    ...
                                                    <div>
                                                        <input type="number" name="bounty{{$type_v['alias']}}" class="mis-txt" @if($task['type_id'] == $type_v['id'] && $task['bounty'] > 0)value="{{floatval($task['bounty'])}}" @endif
