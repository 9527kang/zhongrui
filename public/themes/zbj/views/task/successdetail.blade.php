        ...
        <div class="col-md-12 case-detail-main-area case-container-main">
            <div class="case-detail-title-name">
                ...
                <p>
                    ...
                    <span class="price_box_styleS">交易金额：￥{{ $success_case['cash'] }}</span>
                </p>
            </div>
                    ...
                    <div class="bdsharebuttonbox pull-right" data-tag="share_1">
                        <div class="shop-sharewrap">
                            <div class="share_top_style">
                                <a href="javascript:void(0);" class="" onClick="dofristshare('sina','{{$success_case['title']}}')">
                                    <img src="{!! Theme::asset()->url('images/sina.png') !!}" alt="新浪微博">
                                </a>

                                <a href="javascript:void(0);" class="" onClick="dofristshare('tx','{{$success_case['title']}}')">
                                    <img src="{!! Theme::asset()->url('images/tx.png') !!}" alt="腾讯微博">
                                </a>

                                <a href="javascript:void(0);" class="" onClick="dofristshare('rr','{{$success_case['title']}}')">
                                    <img src="{!! Theme::asset()->url('images/rr.png') !!}" alt="人人网">
                                </a>

                                <a href="javascript:void(0);" class="" onClick="dofristshare('qzone','{{$success_case['title']}}')">
                                    <img src="{!! Theme::asset()->url('images/qq.png') !!}" alt="QQ空间">
                                </a>

                                <a href="javascript:void(0);" class="" onClick="dofristshare('douban','{{$success_case['title']}}')">
