                            ...
                            <div class="bdsharebuttonbox" data-tag="share_1" style="display: inline-block;vertical-align: bottom;">
                                <div class="shop-sharewrap">
                                    <div class="share_top_style">
                                        <a href="javascript:void(0);" class="" onClick="dofristshare('sina','{{$info['title']}}')">
                                            <img src="{!! Theme::asset()->url('images/sina.png') !!}" alt="新浪微博">
                                        </a>

                                        <a href="javascript:void(0);" class="" onClick="dofristshare('tx','{{$info['title']}}')">
                                            <img src="{!! Theme::asset()->url('images/tx.png') !!}" alt="腾讯微博">
                                        </a>

                                        <a href="javascript:void(0);" class="" onClick="dofristshare('rr','{{$info['title']}}')">
                                            <img src="{!! Theme::asset()->url('images/rr.png') !!}" alt="人人网">
                                        </a>

                                        <a href="javascript:void(0);" class="" onClick="dofristshare('qzone','{{$info['title']}}')">
                                            <img src="{!! Theme::asset()->url('images/qq.png') !!}" alt="QQ空间">
                                        </a>

                                        <a href="javascript:void(0);" class="" onClick="dofristshare('douban','{{$info['title']}}')">
