<div class="footer" style="background:#232830">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-8 col-sm-8 g-address col-left">
                <div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-4 g-contact hidden-xs">
                <div class="cor-gray63 text-size14 g-contacthd"><span>联系方式</span></div>
                <div class="space-6"></div>
                <p class="cor-gray63">服务热线：{!! Theme::get('site_config')['phone'] !!}       </p>
                <p class="cor-gray63">{!! Theme::get('site_config')['Email'] !!}</p>
            </div>
            <div class="col-lg-3 focusus hidden-sm hidden-md hidden-xs col-left">
