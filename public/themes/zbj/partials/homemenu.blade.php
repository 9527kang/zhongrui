                            ...
                            <div class="immediate_search">
                                <form>
                                    <div class="form-group clearfix">
                                        <input class="pull-left" type="text" name=""/>
                            ...
                            <div class="consultation_fw" style="display:none;">
                                <ul id="myTab" class="clearfix">
                                    <li class="pull-left active">
                                        <a href="#home1" data-toggle="tab">软件开发</a>
                                    </li>
                                    <li class="pull-left">
                                        <a href="#home2" data-toggle="tab">网络推广</a>
                                    </li>
                                    <li class="pull-left">
                                        <a href="#home3" data-toggle="tab">文案设计</a>
                                    </li>
                                    <li class="pull-left">
                                        <a href="#home4" data-toggle="tab">品牌营销</a>
                                    </li>
                                    <li class="pull-left">
                                        <a href="#home5" data-toggle="tab">企划设计</a>
                                    </li>
                                    <li class="pull-left">
                                        <a href="#home6" data-toggle="tab">活动策划</a>
                                    </li>
                                </ul>
                                <div id="myTabContent" class="tab-content">
                                    ...
                                    <ul class="tab-pane fade row" id="home2">
                                        <li class="clearfix col-xs-4">
                                            <div class="pull-left">
                                                <h6>接单达人2</h6>
                                                <p>全面打造以接单为目的的服务宗旨</p>
                                    ...
                                    <ul class="tab-pane fade row" id="home3">
                                        <li class="clearfix col-xs-4">
                                            <div class="pull-left">
                                                <h6>接单达人3</h6>
                                                <p>全面打造以接单为目的的服务宗旨</p>
                                    ...
                                    <ul class="tab-pane fade row" id="home4">
                                        <li class="clearfix col-xs-4">
                                            <div class="pull-left">
                                                <h6>接单达人4</h6>
                                                <p>全面打造以接单为目的的服务宗旨</p>
                                    ...
                                    <ul class="tab-pane fade row" id="home5">
                                        <li class="clearfix col-xs-4">
                                            <div class="pull-left">
                                                <h6>接单达人5</h6>
                                                <p>全面打造以接单为目的的服务宗旨</p>
                                    ...
                                    <ul class="tab-pane fade row" id="home6">
                                        <li class="clearfix col-xs-4">
                                            <div class="pull-left">
                                                <h6>接单达人6</h6>
                                                <p>全面打造以接单为目的的服务宗旨</p>
