...
<form class="form-horizontal userEdit" role="form" action="{!! url('manage/userEdit') !!}" method="post">
    {!! csrf_field() !!}
	<div class="g-backrealdetails clearfix bor-border">
		...
		<div class="bankAuth-bottom clearfix col-xs-12">
			...
			<p class="col-sm-4">
				<input type="text" name="mobile" id="form-field-1"   class="col-xs-10 col-sm-5" value="{!! $info['mobile'] !!}" onchange="checkMobile(this,'{!! $info['id'] !!}')">
				<span class="Validform_checktip mobile_check"></span>
			</p>
		</div>
		<div class="bankAuth-bottom clearfix col-xs-12">
		...
		<div class="bankAuth-bottom clearfix col-xs-12">
			...
			<p class="col-sm-4">
				<input type="text" name="email" id="form-field-1"  class="col-xs-10 col-sm-5" datatype="e" value="{!! $info['email'] !!}" onchange="checkEmail(this,'{!! $info['id'] !!}')">
				<span class="help-inline col-xs-12 col-sm-7"><i class="light-red ace-icon fa fa-asterisk"></i></span>
				<span class="Validform_checktip email_check"></span>
			</p>
		</div>
		<div class="bankAuth-bottom clearfix col-xs-12">
