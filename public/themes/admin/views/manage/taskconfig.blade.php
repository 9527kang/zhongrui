                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-hover mg-bottom0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td> <input type="text" name="{{ $config['task_bounty_limit']['id'] }}" value="{{ $config['task_bounty_limit']['rule'] }}" class="change_ids"> 元(赏金≤该金额时的任务需要审核，为0无需审核)</td>
                                                    </tr>
                                                    <tr>
                                        ...
                                        <div class="widget-main row paddingTop">
                                            <div class="table-responsive">
                                                <table class="table table-hover mg-bottom0">
                                                    ...
                                                    <tr>
                                                        <td class="col-sm-2 flow-money text-right">新注册用户投稿时间限制：</td>
                        ...
                        <div id="power" class="tab-pane {{ ($id==2)?'active row':'' }}">
                            ...
                            <div class="col-sm-12 power-chunk">
                                <div class="col-sm-6 power-buy">
                                    <div class="widget-box">
                                        <div class="widget-header widget-header-flat">
                                            <h5 class="widget-title">发布任务　　买家（{!! Theme::get('site_config')['site_employer'] ? Theme::get('site_config')['site_employer'] : '雇主' !!}）</h5>
                                        </div>
                                        <div class="widget-body">
                                ...
                                <div class="col-sm-6 power-sell">
                                    <div class="widget-box">
                                        <div class="widget-header widget-header-flat">
                                            <h5 class="widget-title">交稿　　卖家（{!! Theme::get('site_config')['site_employee'] ? Theme::get('site_config')['site_employee'] : '威客' !!}）</h5>
                                        </div>
                                        <div class="widget-body">
                                            <div class="widget-main">
                                                <form>
