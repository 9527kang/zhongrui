        ...
        <table id="sample-table-1" class="table table-striped table-bordered table-hover">
            ...
            <tr>
                ...
                <td>
                    ...
                    <span>
                        <input type="checkbox" name="is_send_email" value="1" class="is_send_email"@if($item->is_send_email == 1)checked @endif>发送邮件
                    </span>
                    <span>
                        <input type="checkbox" name="is_send_mobile" value="1" class="is_send_mobile"@if($item->is_send_mobile == 1)checked @endif>发送短信
                    </span>
                    @endif
                </td>
