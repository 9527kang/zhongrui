                                ...
                                <div id="main{{ $v['id'] }}">
                                    <ul id='browser{{ $v['id'] }}' class='filetree'>
                                        <li>
                                            <span class='folder'>
                                                @if(!empty($v['_child']))
                                                    <input type="checkbox" name="id[]" id="t{{ $v['id'] }}" pId="t0" onchange="child(this)"/>
                                                @endif
                                                {{ $v['name'] }}
                                            </span>
                                            @if(!empty($v['_child']))
    ...
    function child(e) {
        ...
        if (checked) {
            ...
            for (var i = 0; i < children.length; i++) {
                ...
                var children_chil=$("input[pId='" + children.eq(i).attr('id') + "']");
                for(var j=0 ;j<children_chil.length;j++){
                    $(children_chil[j]).prop("checked", checked);
                    var children_chilThird=$("input[pId='" + children_chil.eq(j).attr('id') + "']");
                    for(var k=0 ;k<children_chilThird.length;k++){
                        $(children_chilThird[k]).prop("checked", checked);
                    }
                }
