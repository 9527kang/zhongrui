                        ...
                        <form action="/manage/taskDetailUpdate" method="post" id="seo-form" class="form-horizontal">
                            <div class="g-backrealdetails clearfix bor-border interface">
								...
								<div class="form-group interface-bottom col-xs-12">
									...
									<div class="col-sm-9">
										<label class="col-sm-1">@if($task['bounty_status'] == 0)可议价@else￥{{ $task['bounty'] }}元@endif</label>
									</div>
								</div>
								<div class="form-group interface-bottom col-xs-12">
				...
				@foreach($work_delivery as $v)
					<div class="col-lg-5 col-md-12 col-xs-12 draft table-bordered deal clearfix">
						...
						<div class="draft-inline col-xs-10">
							<p>（{!! Theme::get('site_config')['site_employer'] ? Theme::get('site_config')['site_employer'] : '雇主' !!}）{{ $task['nickname'] }}   <a target="_blank" href="{{ URL('manage/userEdit',['id'=>$task['uid']]) }}" class="btn btn-primary pull-right btn-sm">查看详情</a></p>
