    ...
    <div class="g-backrealdetails clearfix bor-border interface">
        ...
        <div class="form-group interface-bottom col-xs-12">
            ...
            <div class="col-sm-8">
                ...
                <label>
                    <input type="checkbox" class="drag-tabinp" value="{{$pv['id']}}" data-code="{{$pv['code']}}">
        ...
        <div class="form-group interface-bottom col-xs-12" id="TASK_WORK" style="display: none;">
            <label class="col-sm-1 control-label no-padding-right" for="form-field-1">竞标次数/天</label>

            <div class="col-sm-8">
                <input type="text" name="TASK_WORK" value="">
            </div>

        </div>
        <div class="form-group interface-bottom col-xs-12" id="MOST_TASK_BOUNTY" style="display: none;">
            <label class="col-sm-1 control-label no-padding-right" for="form-field-1">可竞标最高金额</label>

            <div class="col-sm-8">
                <input type="text" name="MOST_TASK_BOUNTY" value="">
            </div>

        </div>
        <div class="form-group interface-bottom col-xs-12" id="SKILL_TAGS_NUM" style="display: none;">
            <label class="col-sm-1 control-label no-padding-right" for="form-field-1">技能标签数量</label>

            <div class="col-sm-8">
                <input type="text" name="SKILL_TAGS_NUM" value="">
            </div>

        </div>
        <div class="form-group interface-bottom col-xs-12" id="SERVICE_OFF" style="display: none;">
            <label class="col-sm-1 control-label no-padding-right" for="form-field-1">增值工具折扣%</label>

            <div class="col-sm-8">
                <input type="text" name="SERVICE_OFF" value="">
            </div>
