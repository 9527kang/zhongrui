...
<form class="form-horizontal clearfix registerform" role="form" action="{!! url('manage/managerDetail') !!}" method="post">
	...
	<div class="g-backrealdetails clearfix bor-border">
		...
		<div class="bankAuth-bottom clearfix col-xs-12">
			...
			<div class="col-sm-4">
				<p class="input-group input-group-sm col-xs-10 col-sm-4">
					<input type="text" id="datepicker" class="form-control hasDatepicker" value="{{ $info['birth'] }}" name="birth" autocomplete="new-password">
		...
		<div class="bankAuth-bottom clearfix col-xs-12">
			...
			<p class="col-sm-4">
				<input type="password" id="form-field-1"  class="col-xs-10 col-sm-5"  name="password" datatype="*" value="{{ $info['password'] }}" autocomplete="new-password">
				<span class="help-inline col-xs-12 col-sm-7"><i class="light-red ace-icon fa fa-asterisk"></i></span>
			</p>
		</div>
