    ...
    <div class="row">
        <div class="col-lg-9 list-l col-md-12 col-left">
                            ...
                            <div class="row">
                                <ul class="mg-margin list-inline task-list-label">
                                    <li class="cor-gray51 clearfix p-space">
                                        ...
                                        {!! Theme::get('site_config')['site_employer'] ? Theme::get('site_config')['site_employer'] : '雇主' !!}：<span class="">{{ $detail['user_name'] }}</span>
                                    </li>
                                    <li class="cor-gray51 clearfix p-space">
                                    ...
                                    <li class="cor-gray51 clearfix p-space">
                                        ...
                                        分类：@if($detail['type'] == 0 || $detail['cate_name']){{ $detail['cate_name'] }} @else {{ $detail['tag_pname'].'/'.$detail['tag_name'] }} @endif
                                    </li>
                                    @if($detail['region_limit'])
                                        <li class="cor-gray51 clearfix p-space">
                                            <span class="t-ico t-ico2"></span>
                                            地区：
                                            @if(isset($area[$detail['province']]['name']))
                                                {{ $area[$detail['province']]['name']}}
                                            @endif
                                            @if(isset($area[$detail['city']]['name'] ))
                                                {{$area[$detail['city']]['name'] }}
                                            @endif
                                            @if(isset($area[$detail['area']]['name']))
                    ...
                    <div class="tasksidebg-white">
                        ...
                        @if(($detail['status']==3 || $detail['status']==4 || $detail['status']==5) && $user_type==3)
                            ...
                            @if($detail['type'] == 0)
                                ...
                                @endif
                            @else
                                <a href="{{ $detail['url'] }}" target="_blank"  class="btn btn-primary bor-radius2">立即投稿</a>
                            @endif
                        ...
                        @endif
                            <a href="/task/release/{{ $detail['id'] }}?type=1" class="btn">
                                发布类似任务
                            </a>
                        </div>
                    ...
                    <div id="home" class="tab-pane fade  bg-white active in">
                        ...
                        <div class="task-description cor-gray51">
                            <div class="description-main">
                                ...
                                <div class="h5 height-line24 js_moreDetail" style="word-break:break-all;height:55px;overflow:hidden;">
                                    {!! $detail['desc'] !!}
                                </div>
            ...
            <ul class="tasknav clearfix mg-margin nav nav-tabs">
                ...
                @if($detail['status'] >= 3 && $detail['status'] <=5 && $user_type == 1)
                    <li class="{{ ((!empty($_COOKIE['table_index']) && $_COOKIE['table_index']==6) || !isset($_COOKIE['table_index']))?'active':'' }}" index="6" onclick="rememberTable($(this))">
                        <a href="#home6" data-toggle="tab" class="text-size16">邀约高手</a>
                    </li>
                @endif
            ...
            <div class="tab-content b-border0 pd-padding0">
                                    ...
                                    <div class="evaluate row">
                                        ...
                                        <div class="col-md-11 col-xs-10 evaluatemain">
                                            ...
                                            <div class="text-right">
                                                @if(Auth::check())
                                                    <a class="evaluateshow text-under blue get-comment" url="/task/getComment" work_id = '{{ $v['id'] }}' num="0" onclick="evaluateshow($(this))"  >回复(<span>{{ count($v['children_comment']) }}</span>)</a>
                                                @else
                                                    <a class="evaluateshow text-under blue" url="/task/getComment" work_id = '{{ $v['id'] }}' onclick="loginremaind($(this))"  >回复<span>{{ count($v['children_comment']) }}</span></a>
                                                @endif
                    ...
                    @else
                        <div class="norecord">
                            <div class="tab-content text-center text-gray">
                                ...
                                <div class="detail-nomessage">暂无稿件哦 ！</div>
                            </div>
                        </div>
                    @endif
                ...
                @if(!empty($delivery['data']) && $user_type!=3  && ($is_delivery || $user_type==1))
                    ...
                    @endif
                    @if($detail['status'] >= 3 && $detail['status'] <=5 && $user_type == 1)
                        <div id="home6" class="invite_home6 tab-pane fade {{ (!empty($_COOKIE['table_index']) && $_COOKIE['table_index']==6)?'active':'' }} in">
                            <div class="input_group_all">
                                <div class="form-inline">
                                    <div class="form-group form_group_m1">
                                        <label for="exampleInputName2" class="font_label_style">名称</label>
                                        <input type="text" class="form-control" id="exampleInputName2" placeholder="请输入服务商名称" name="service_name">
                                        <input type="hidden" id="invite_task_id" value="{{$detail['id']}}">
                                    </div>

                                    <!-- 服务商分类 -->
                                    <div class="form-group form_group_m1">
                                        <label for="exampleInputEmail2" class="font_label_style">分类</label>
                                        <div class="all_select_boxShow">
                                            <div id="selectM2">
                                                <span class="select_one01">请选择</span>
                                                <b class="down_icon"></b>
                                            </div>
                                            <div class="parent_box_m2">
                                                <ul class="first_box_m2"></ul>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <!-- 服务商地区 -->
                                    <div class="form-group form_group_m1">
                                        <label for="exampleInputEmail2" class="font_label_style">地区</label>
                                        <div class="all_select_boxShow">
                                            <div id="selectM3">
                                                <span class="select_one02">请选择</span>
                                                <b class="down_icon"></b>
                                            </div>
                                            <div class="parent_box_m6">
                                                <ul class="first_box_m3"></ul>
                                            </div>
                                        </div>
                                    </div>
                                    <a href="javascript:;" class="btn_blue_m3" id="searchBtn">搜索</a>
                                </div>
                            ...
                            <div id="home6_desc">
                                        ...
                                        <li class="pull-left">
                                            ...
                                            <div class="comment_num">
                                                ...
                                                <div class="pull-right comment_btn" id="invite_user_desc{{$v['id']}}">
                                                    ...
                                                    @else
                                                        <div class="but_style" onclick="inviteUser('{{$v['id']}}','{{$detail['id']}}')">邀约TA</div>
                                                    @endif
                                                </div>
                                            </div>
                                        </li>
                                ...
                                <div class="pull-right" id="home6_page">
                                    {!! $inviteUser->appends(['task_id' => $detail['id']])->render() !!}
                                </div>
                            </div>
            ...
            <div class="taskside taskside-points ">
                ...
                <div class="bdsharebuttonbox" data-tag="share_1">
                    <div class="share_top_style">
                        <a href="javascript:void(0);" class="" onClick="dofristshare('sina','{{$detail['title']}}')">
                            <img src="{!! Theme::asset()->url('images/sina.png') !!}" alt="新浪微博">
                        </a>

                        <a href="javascript:void(0);" class="" onClick="dofristshare('tx','{{$detail['title']}}')">
                            <img src="{!! Theme::asset()->url('images/tx.png') !!}" alt="腾讯微博">
                        </a>

                        <a href="javascript:void(0);" class="" onClick="dofristshare('rr','{{$detail['title']}}')">
                            <img src="{!! Theme::asset()->url('images/rr.png') !!}" alt="人人网">
                        </a>

                        <a href="javascript:void(0);" class="" onClick="dofristshare('qzone','{{$detail['title']}}')">
                            <img src="{!! Theme::asset()->url('images/qq.png') !!}" alt="QQ空间">
                        </a>

                        <a href="javascript:void(0);" class="" onClick="dofristshare('douban','{{$detail['title']}}')">
                            <img src="{!! Theme::asset()->url('images/db.png') !!}" alt="豆瓣">
                        </a>
                        <a href="javascript:void(0);" class="wxShareTask" >
                            <img src="{!! Theme::asset()->url('images/weixin.png') !!}" alt="微信">
                            <div class="pic_ewm">
                                {!! $wechat_share !!}
...
<div id="task_cate" data-values="{{json_encode($category_all)}}"></div>
<div id="district_second" data-values="{{json_encode($province)}}"></div>
...
{!! Theme::asset()->container('custom-js')->usepath()->add('share', 'js/share.js') !!}
