                ...
                @foreach($list->toArray()['data'] as $item)
                    <li class="clearfix">
                        <div class="col-sm-2 col-xs-2 m-serivcebox">
                            ...
                            @if(isset($item['is_recommend']) && isset($item['shopId']) && $item['is_recommend'] == 1 && $item['shop_status'] == 1 && $item['shopId'])
                        ...
                        <div class="col-sm-9 col-xs-10 nopdr">
                            <div class="">
                                <a class="cor-blue2f text-size18 text-blod "
                                   href="@if(isset($item['shopId']) && $item['shop_status'] == 1 && $item['shopId']) {!! url('shop/'.$item['shopId']) !!}
                        ...
                        @if(isset($item['shopId']) && $item['shop_status'] == 1 && $item['shopId'])
