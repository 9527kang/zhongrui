                        ...
                        <div class="tab-content clearfix f-tab">
                            ...
                            @else
                                ...
                                <div class="text-size14 cor-gray51">
                                    <p>您的账户可用余额：<span>￥{{ $userInfo->balance }}</span></p>
                                    <button type="button" class="close" data-dismiss="alert">
                                        <i class="icon-remove"></i>
                                    </button>
                                    您的余额不足，请选择其他支付方式或是去　<a href="/finance/cash" class="btn btn-sm btn-orange34 bor-radius2">充值</a>　<a href="javascript:history.back();" class="cor-gray93 btn-big">返回</a>
                                    <br>
                                </div>
                            @endif
                            <!--第三方支付-->
