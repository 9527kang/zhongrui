        ...
        <form action="/user/workComment" method="get" id="screen_form">
            ...
            <div class=" pull-right">
                <select name="from" class="form-control btn-big screen">
                    <option value="0" {{ (empty($_GET['from']) || $_GET['from']==0)?'selected':'' }}>给{!! Theme::get('site_config')['site_employer'] ? Theme::get('site_config')['site_employer'] : '雇主' !!}的评价</option>
                    <option value="1" {{ (!empty($_GET['from']) && $_GET['from']==1)?'selected':'' }}>{!! Theme::get('site_config')['site_employer'] ? Theme::get('site_config')['site_employer'] : '雇主' !!}给我的评价</option>
                </select>
            </div>
        </form>
    </div>
