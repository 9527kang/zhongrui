<div class="g-main g-releasetask g-usershop">
    ...
    <form method="post" action="/user/postEditShopSuccess" enctype="multipart/form-data" id="shopSuccess">
        ...
        <div class="g-userimgup profile-users g-usershopform">
            ...
            <div class="clearfix g-userimgupbor task-casehid"><p class="pull-left h5 cor-gray51">案例金额</p>
                <p class="g-userimgupinp g-userimgupbor-validform">
                    <input class="inputxt Validform_error input-large" type="text" datatype="decimal" nullmsg="请填写案例金额" errormsg="案例金额最多两位小数" name="cash" value="{!! $success_info->cash !!}">&nbsp;&nbsp;&nbsp;
                </p>
            </div>
