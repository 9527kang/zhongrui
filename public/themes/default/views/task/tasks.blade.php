<div class="g-taskposition col-lg-12 col-left">您的位置：<a href="/">首页</a> > {{$NavName}}</div>
<div class="col-lg-9 col-left">
    <div class="g-taskprocess hidden-xs">
        <div class="row">
            <div class="col-md-4 col-xs-4"><div class="g-taskpro1 pull-left"><span>免费发布任务</span><p>免费发布</p></div><div class="g-taskproico1 pull-right">></div></div>
            <div class="col-md-4 col-xs-4"><div class="g-taskpro2 pull-left"><span>服务商投标</span><p>多家{!! Theme::get('site_config')['site_employee'] ? Theme::get('site_config')['site_employee'] : '威客' !!}，择优雇佣</p></div><div class="g-taskproico2 pull-right">></div></div>
