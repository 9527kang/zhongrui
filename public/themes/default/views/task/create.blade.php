...
<div class="g-taskposition col-xs-12 col-left">您的位置：首页 > 任务大厅</div>
...
<div class="col-lg-9 list-l col-left">
    <form action="/task/createTask" method="post" id="form" enctype="multipart/form-data">
                        ...
                        <div class="panel">
                            ...
                            {{ (!empty(old('xuanshang')))?'in':'' }}" id="ck">
                                <div class="mission-ck z-check-validform-ck">
                                    ...
                                    <!-- <div>
                                        <input type="date" name="" class="mis-txt"
                                               datatype="positive"  nullmsg=""
                                               errormsg="">
                                        @if($errors->first('worker_num'))
                                            <p class="Validform_checktip Validform_wrong">
                                                {!! $errors->first('worker_num') !!}</p>
                                    ...
                                    <!-- <ul class="clearfix checkbox process">
                                        ...
                                        <li class="pull-left">
                                            <span></span>
                                            <p>{!! Theme::get('site_config')['site_employer'] ? Theme::get('site_config')['site_employer'] : '雇主' !!}选稿</p>
                                        </li>
                                        <li class="pull-left">
                                            <span></span>
                                            <p>中标公开</p>
                            ...
                            <div class="mission-task panel-collapse collapse
                                ...
                                @endif
                                    <input name="begin_at{{$type_v['alias']}}" type="hidden" id="begin_at1" datatype="*"
                                           nullmsg="请填写开始时间！" class="begin_at" value="{!! (old('begin_at'))?old('begin_at'):date('Y年m月d日',time()) !!}"/>
                            ...
                            @foreach($service as $v)
                                <li class="clearfix">
                                    ...
                                    <div class="pull-right vat-txt">
                                        ￥{{ number_format($v['price']/100*$off,2) }}
                                    </div>
                                </li>
                            @endforeach
                            <li class="clearfix">
        ...
        <div class="task-bt">
            <h3><strong class="title_money_m1">结算清单</strong></h3>
            <p class="text-size14 font_style_m1">托管赏金：<span>￥<span id="bounty_money">0</span></span></p>
            ...
            <p class="text-size14 font_style_m1">应付总额 <span>￥<span id="total-price">0</span></span></p>
            ...
            <button class="btn btn-primary btn-blue bor-radius2 btn-big3 preservation btn_big3_m1" onclick="sluSub(1)">
                保存
            </button>
...
<div class="col-lg-3 task-l hidden-xs hidden-md hidden-sm col-left">
    <div class="taskside">
        ...
        <a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin={{ $qq }}&site=qq&menu=yes"
           class="btn btn-block btn-primary bor_radius_m3 text-size14 btn-blue">联系在线客服</a>
        <div class="space"></div>
        <div class="iss-ico1">
    ...
    <div class="taskside1">
        <a href="#">
            <img src="/themes/default/assets/images/baner_issur_img.png" alt="" class="img-responsive" width="100%">
        </a>
        <!-- @if(count($ad))
            <a href="{!! $ad[0]['ad_url'] !!}">
