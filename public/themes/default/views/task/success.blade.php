    ...
    <div class="row  case-list">
        @foreach($list as $v)
            <div class="col-md-3 col-xs-12 col-sm-4 case-list-item">
                <a class="case-list-item-img" style="position:relative;" href="{{ URL('task/successJump',['id'=>$v['id']]) }}" target="_blank">
                    <img src="{{ $domain.'/'.$v['pic'] }}" alt="">
                    <span class="positionBox_m1">
                        <span class="pull-left">交易金额：￥{{$v['cash']}}</span>
                        <span class="pull-right">中标人：{{$v['nickname']}}</span>
                    </span>
                </a>
