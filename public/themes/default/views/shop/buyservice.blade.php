                ...
                <div class="personal-info-words clearfix buygoods-info-words">
                    ...
                    <div class="personal-info-block-name">
                        ...
                        <div class="alert alert-warning mg-bottom10">
                            <p class="text-size12 cor-gray51"><span class="cor-gray89">服务分类：</span>@if(in_array($service['cate_id'],array_keys($all_cate))){{ $all_cate[$service['cate_id']]['name'] }}@endif</p>
                        ...
                        <div class="clearfix buygoods-btn-wrap">
                            ...
                            @if(Auth::check())
                                ...
                                @elseif( Theme::get('is_IM_open') == 1)
                                    <a class="shop-callme shop-im"  href="javascript:;" data-values="{!! $service['uid'] !!}">联系我</a>
                                @endif
                            @else
                            ...
                            <div class="bdsharebuttonbox" data-tag="share_1">
                                <div class="shop-sharewrap"><span class="pull-left cor-gray51">分享：&nbsp;</span>
                                    <div class="share_top_style">
                                        <a href="javascript:void(0);" class="" onClick="dofristshare('sina','{{$service['title']}}')">
                                            <img src="{!! Theme::asset()->url('images/sina.png') !!}" alt="新浪微博">
                                        </a>

                                        <a href="javascript:void(0);" class="" onClick="dofristshare('tx','{{$service['title']}}')">
                                            <img src="{!! Theme::asset()->url('images/tx.png') !!}" alt="腾讯微博">
                                        </a>

                                        <a href="javascript:void(0);" class="" onClick="dofristshare('rr','{{$service['title']}}')">
                                            <img src="{!! Theme::asset()->url('images/rr.png') !!}" alt="人人网">
                                        </a>

                                        <a href="javascript:void(0);" class="" onClick="dofristshare('qzone','{{$service['title']}}')">
                                            <img src="{!! Theme::asset()->url('images/qq.png') !!}" alt="QQ空间">
                                        </a>

                                        <a href="javascript:void(0);" class="" onClick="dofristshare('douban','{{$service['title']}}')">
                        ...
                        <ul>
                            ...
                            <li class="personal-evaluate-list-item">
                                ...
                                <div class="personal-case-evaluate-person-time personal-shop-evaluate-time pull-right text-right">
                                    ...
                                    <div class="space-6"></div>
                                    <p><span>{!! Theme::get('site_config')['site_employer'] ? Theme::get('site_config')['site_employer'] : '雇主' !!}：<span class="span-space p-space">{{ $v['user_name'] }}</span></span>&nbsp;<span>评价于：{{ date('Y-m-d',strtotime($v['created_at'])) }}</span></p>
                                </div>
                            </li>
                            @endforeach
                        </ul>
                    ...
                    <li class="col-md-3 col-sm-4 col-xs-6">
                        ...
                        <div class="shop-maininfo">
                            ...
                            <p class="clearfix cor-gray89">
                                <span class="case-tag pull-left"> <i class="fa fa-tag cor-grayD3 text-size16"></i>&nbsp;&nbsp;@if(in_array($v['cate_id'],array_keys($all_cate))){{ $all_cate[$v['cate_id']]['name'] }}@endif</span>
