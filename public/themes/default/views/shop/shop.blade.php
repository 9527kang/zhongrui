    ...
    <div class="personal-info">
        ...
        <div class="personal-info-words">
            ...
            <div class="personal-info-block">
                ...
                <p class="hidden-xs cor-gray51" style="line-height:30px;">地&nbsp;&nbsp;&nbsp;址：&nbsp;
                ...
                <p class="personal-tag hidden-xs cor-gray51">标&nbsp;&nbsp;&nbsp;签：&nbsp;
                    ...
                    <span class="cor-gray87 label_text_m1">{!! $tv['tag_name'] !!}</span>
                    @endforeach
                </p>
                @endif
                <p class="cor-gray51" style="line-height:40px;">好评率：&nbsp;<span class="cor-orange">@if(!empty($shopInfo)) {!! $shopInfo['percent'] !!} @else 100 @endif %</span>&nbsp;&nbsp;&nbsp;好评数：<span class="cor-orange">@if($shopInfo['good_comment']) {!! $shopInfo['good_comment'] !!} @else 0 @endif</span>&nbsp;&nbsp;&nbsp;累计服务：<span class="cor-orange"> @if($shopInfo['serviceNum']) {!! $shopInfo['serviceNum'] !!} @else 0 @endif </span></p>
                ...
                <div class="clearfix">
                    <a class="shop_ewm_m1"  href="javascript:;">
                        用手机逛本店
                        <div class="pic_ewm">
                            {!! $img !!}
            ...
            <div class="shop-mainlistwrap">
                <ul class="row shop-mainlist">
                    @foreach($caseInfo as $cv)
                        <li class="col-md-2 col-sm-4 col-xs-6">
                            <div class="shop-mainimg shop-mainimg234">
                                <a href="{!! URL('/shop/successDetail/'.$cv['id']) !!}">
