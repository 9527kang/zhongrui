...
<div class="bg-white s-slidecenter">
    <div class="accordion-style1 panel-group accordion-style2 g-side1" id="accordion1">
        ...
        <div class="panel panel-default ">
            ...
            <div id="collapse3"
                 class="panel-collapse {{ ($_SERVER['REQUEST_URI']=='/user/realnameAuth' || $_SERVER['REQUEST_URI']=='/user/paylist' || $_SERVER['REQUEST_URI']=='/user/emailAuth' || $_SERVER['REQUEST_URI']=='/user/phoneAuth' || $_SERVER['REQUEST_URI']=='/user/enterpriseAuth')?'in':'collapse' }}">
