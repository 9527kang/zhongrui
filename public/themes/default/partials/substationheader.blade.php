        ...
        <div class="row">
            <div class="col-xs-12 col-left col-right">
                <nav class="navbar bg-blue navbar-default hov-nav" role="navigation">
                    <div class="navbar-header pull-left g-logo hidden-xs hover_nav_boxShow">
                        ...
                        <span class="hov-showdrop">
                            <i class="fa fa-reorder cussor-pointer hidden-xs h-hovheader text-size14"></i>
                            ...
                            <div class="parent_box parent_box_H1">
                                <ul class="ul_one">
                                    @forelse(Theme::get('task_cate') as $k => $v)
                                        @if(isset($v['pid']) && $v['pid'] == 0)
                                            <li>
