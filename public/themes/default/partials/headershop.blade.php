                ...
                <div class="col-lg-5 col-md-5 hidden-sm brand_title_m1">
                    <div class="row">
                        <div class="pull-left title_brand_m1">
                            <span>{!! Theme::get('SHOPNAME') !!}</span>
                        </div>
                        <div class="pull-left title_brand_m2">
                            <span>工作速度：{!!isset( Theme::get('SHOPCOMMENT')['speedScore']) ?  Theme::get('SHOPCOMMENT')['speedScore'] : 5.0 !!}&nbsp; | &nbsp; </span>
                            <span>工作质量：{!!isset( Theme::get('SHOPCOMMENT')['qualityScore']) ?  Theme::get('SHOPCOMMENT')['qualityScore'] : 5.0 !!} &nbsp; | &nbsp; </span>
                            <span>工作态度：{!!isset( Theme::get('SHOPCOMMENT')['attitudeScore']) ?  Theme::get('SHOPCOMMENT')['attitudeScore'] : 5.0 !!}</span>
                        </div>
                    </div>
                </div>
