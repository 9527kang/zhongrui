...
//            $taskWinTitle = $taskWinArr->name;
    ...
    //获取导航名称
	static function getNavName($url){
		$NavTitle=NavModel::where('link_url',$url)->select('title')->first();
		if($NavTitle){
    ...
    static function taskSchedulingArtisan()
    {
        ...
        Artisan::call('EmployAccept');
        Artisan::call('EmployComment');
        Artisan::call('EmployDeadline');
        Artisan::call('EmployDelivery');

        Artisan::call('BuyGoods');
        Artisan::call('GoodsComment');

        Artisan::call('vipshop');
    }
     ...
     * @return array
     */
    static public function getFinanceAction()
    {
        $arr = [
            1 => '发布任务',
            2 => '任务佣金',
     ...
     * @return array
     */
    static public function incomeArr()
    {
        $arr = [2, 3, 7, 8,9,10,11,13,14];
        return $arr;
    }
     ...
     * @return array
     */
    static public function outcomeArr()
    {
        $arr = [1,4,5,6,12,15];
        return $arr;
    }
     ...
     * @return array
     */
    static public function getPayType()
    {
        $arr = [
            1 => '余额',
            2 => '支付宝',
     ...
     * @return array
     */
    static public function setArrayKey($array, $key,$level=1,$value='')
    {
        $result = array();
        if (is_array($array)) {
            if($level==1){
